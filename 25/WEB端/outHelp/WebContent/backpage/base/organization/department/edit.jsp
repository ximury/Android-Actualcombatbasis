...
<body>
	...
	<div class="centent" style="padding-top: 10px;">
		<form id="dataform" method="post" action="${ctx}/back/department.do?cmd=saveOrUpdate">
			<span> <input type="hidden" name="pid" value="${param.pid}"> <input type="hidden" name="id" value="${department.id}">
			</span>
